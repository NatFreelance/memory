...
export default function App() {
    ...
    useEffect(() => {
        if (emojisArray.length && matchedCards.length === emojisArray.length) {
   ...
   async function startGame(e) {
       ...
       try {
            ...
            const categoryData = emojisData[formData.category]
            if (!categoryData) {
                throw new Error("Category not found")
            }
            
            const dataSlice = await getDataSlice(categoryData)
            const gameEmojisArray = await getEmojisArray(dataSlice)

            setEmojisArray(gameEmojisArray)
            setIsGameOn(true)
